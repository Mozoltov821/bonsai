...
# Create a JITted version with default vocab limit
@jax.jit
def forward_jit(model: nnx.Module, cache: Cache, tokens: Array, pad_id: int) -> tuple[Array, nnx.Cache]:
    return forward(model, cache, tokens, pad_id, vocab_limit=151643)